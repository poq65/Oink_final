...
/**
 * Created by jihyun on 2017-07-23.
 */
...
public class PermissionRequester {
    ...
    private void setBuilder(Builder builder) { this.builder = builder; }
    ...
    public int request(final String permission, final int requestCode, final OnClickDenyButtonListener denyAction)
    {
        ...
        * * PackageManager.PERMISSION_DENIED : 권한이 없음 * PackageManager.PERMISSION_GRANTED : 권한이 있음. */
            ...
            if (permissionCheck == PackageManager.PERMISSION_DENIED) {
                ...
                * Marshmellow 버젼 이상부터 사용가능함. */
                if (context.shouldShowRequestPermissionRationale(permission)) {
                    ...
                    dialog.setTitle(builder.getTitle()) .setMessage(builder.getMessage())
                            .setPositiveButton(builder.getPositiveButtonName(),
                                    ...
                                    }).setNegativeButton(builder.getNegativeButtonName(), new DialogInterface.OnClickListener()
                    {
                        ...
                        } }).create().show(); return REQUEST_PERMISSION; }
                else {
                    /*
    ...
    public static class Builder
    {
        ...
        public String getPositiveButtonName() { return positiveButtonName; }
        public Builder setPositiveButtonName(String positiveButtonName) { this.positiveButtonName = positiveButtonName; return this; }
        public String getNegativeButtonName() { return negativeButtonName; }
        public Builder setNegativeButtonName(String negativeButtonName) { this.negativeButtonName = negativeButtonName; return this; }
        public PermissionRequester create() { this.requester.setBuilder(this); return this.requester; } }

    public interface OnClickDenyButtonListener { public void onClick(Activity activity); }
}
